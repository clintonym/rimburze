...
var OrganisasiPageModule = /** @class */ (function () {
    function OrganisasiPageModule() {
    }
...
var OrganisasiPage = /** @class */ (function () {
    function OrganisasiPage(orgsService, alertCtrl, router, toastCtrl, modalCtrl, db) {
    ...
    OrganisasiPage.prototype.ngOnInit = function () {
        var _this = this;
        this.user = this.orgsService.getUser();
        this.orgSubs = this.orgsService.getOrgs().subscribe(function (res) {
            _this.loadedOrgs = res;
            console.log(_this.loadedOrgs);
        });
        console.log(this.user);
    };
    OrganisasiPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.user = this.orgsService.getUser();
        this.orgSubs = this.orgsService.getOrgs().subscribe(function (res) {
            _this.loadedOrgs = res;
    ...
    OrganisasiPage.prototype.ngOnDestroy = function () {
        console.log("destroyed");
        this.orgSubs.unsubscribe();
    };
    //Join Group
    OrganisasiPage.prototype.selectOrgs = function (org, iniId) {
    ...
    OrganisasiPage.prototype.orgsOnClick = function (id) {
        this.router.navigate(['/organisasi', id]);
    };
    //Create Group
    OrganisasiPage.prototype.createOnClick = function (orgs) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OrganisasiPage.prototype.createToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OrganisasiPage.ctorParameters = function () { return [
...
//# sourceMappingURL=organisasi-organisasi-module-es5.js.map