...
var OutcomeDetailPageModule = /** @class */ (function () {
    function OutcomeDetailPageModule() {
    }
    ...
    return OutcomeDetailPageModule;
}());
...
var OutcomeDetailPage = /** @class */ (function () {
    function OutcomeDetailPage(actvRoute, activatedOrgs, orgsService, modalCtrl, alertCtrl, toastCtrl, router, db, loadingCtrl) {
        ...
        this.obj = this.objCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (actions) {
    ...
    OutcomeDetailPage.prototype.ngOnInit = function () {
        var _this = this;
        this.loadedOutcome = this.orgsService.getOutcome();
        this.obj.subscribe(function (res) {
            _this.loadedObj = res;
        });
    ...
    OutcomeDetailPage.prototype.deleteObj = function (obj) {
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        firebase__WEBPACK_IMPORTED_MODULE_7__["firestore"]()
                                            .collection('organisasi').doc(_this.orgId).collection('outcome').doc(_this.outcomeId)
    ...
    OutcomeDetailPage.prototype.toastDelete = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OutcomeDetailPage.prototype.getTotalPrice = function () {
        var sumVal = 0;
        if (!this.loadedObj) {
        }
        else if (this.loadedObj) {
            for (var _i = 0, _a = this.loadedObj; _i < _a.length; _i++) {
                var item = _a[_i];
    ...
    OutcomeDetailPage.prototype.addOnClick = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        // this.addLoading();
                                        firebase__WEBPACK_IMPORTED_MODULE_7__["firestore"]()
                                            .collection('organisasi').doc(_this.orgId).collection('outcome').doc(_this.outcomeId).collection('obj').add({
    ...
    OutcomeDetailPage.prototype.doneOnClick = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    text: 'Yes',
                                    handler: function () {
                                        _this.router.navigate(['/organisasi']);
                                        _this.toastDone();
                                    }
                                }
                            ]
    ...
    OutcomeDetailPage.prototype.toastDone = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    OutcomeDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=organisasi-outcome-outcome-detail-outcome-detail-module-es5.js.map